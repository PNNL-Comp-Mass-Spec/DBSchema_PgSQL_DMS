--
-- Name: add_update_experiment_plex_members(text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text); Type: PROCEDURE; Schema: public; Owner: d3l243
--

CREATE OR REPLACE PROCEDURE public.add_update_experiment_plex_members(INOUT _plexexperimentidorname text, IN _plexmembers text, IN _expidchannel1 text DEFAULT ''::text, IN _expidchannel2 text DEFAULT ''::text, IN _expidchannel3 text DEFAULT ''::text, IN _expidchannel4 text DEFAULT ''::text, IN _expidchannel5 text DEFAULT ''::text, IN _expidchannel6 text DEFAULT ''::text, IN _expidchannel7 text DEFAULT ''::text, IN _expidchannel8 text DEFAULT ''::text, IN _expidchannel9 text DEFAULT ''::text, IN _expidchannel10 text DEFAULT ''::text, IN _expidchannel11 text DEFAULT ''::text, IN _expidchannel12 text DEFAULT ''::text, IN _expidchannel13 text DEFAULT ''::text, IN _expidchannel14 text DEFAULT ''::text, IN _expidchannel15 text DEFAULT ''::text, IN _expidchannel16 text DEFAULT ''::text, IN _expidchannel17 text DEFAULT ''::text, IN _expidchannel18 text DEFAULT ''::text, IN _expidchannel19 text DEFAULT ''::text, IN _expidchannel20 text DEFAULT ''::text, IN _expidchannel21 text DEFAULT ''::text, IN _expidchannel22 text DEFAULT ''::text, IN _expidchannel23 text DEFAULT ''::text, IN _expidchannel24 text DEFAULT ''::text, IN _expidchannel25 text DEFAULT ''::text, IN _expidchannel26 text DEFAULT ''::text, IN _expidchannel27 text DEFAULT ''::text, IN _expidchannel28 text DEFAULT ''::text, IN _expidchannel29 text DEFAULT ''::text, IN _expidchannel30 text DEFAULT ''::text, IN _expidchannel31 text DEFAULT ''::text, IN _expidchannel32 text DEFAULT ''::text, IN _expidchannel33 text DEFAULT ''::text, IN _expidchannel34 text DEFAULT ''::text, IN _expidchannel35 text DEFAULT ''::text, IN _channeltype1 text DEFAULT ''::text, IN _channeltype2 text DEFAULT ''::text, IN _channeltype3 text DEFAULT ''::text, IN _channeltype4 text DEFAULT ''::text, IN _channeltype5 text DEFAULT ''::text, IN _channeltype6 text DEFAULT ''::text, IN _channeltype7 text DEFAULT ''::text, IN _channeltype8 text DEFAULT ''::text, IN _channeltype9 text DEFAULT ''::text, IN _channeltype10 text DEFAULT ''::text, IN _channeltype11 text DEFAULT ''::text, IN _channeltype12 text DEFAULT ''::text, IN _channeltype13 text DEFAULT ''::text, IN _channeltype14 text DEFAULT ''::text, IN _channeltype15 text DEFAULT ''::text, IN _channeltype16 text DEFAULT ''::text, IN _channeltype17 text DEFAULT ''::text, IN _channeltype18 text DEFAULT ''::text, IN _channeltype19 text DEFAULT ''::text, IN _channeltype20 text DEFAULT ''::text, IN _channeltype21 text DEFAULT ''::text, IN _channeltype22 text DEFAULT ''::text, IN _channeltype23 text DEFAULT ''::text, IN _channeltype24 text DEFAULT ''::text, IN _channeltype25 text DEFAULT ''::text, IN _channeltype26 text DEFAULT ''::text, IN _channeltype27 text DEFAULT ''::text, IN _channeltype28 text DEFAULT ''::text, IN _channeltype29 text DEFAULT ''::text, IN _channeltype30 text DEFAULT ''::text, IN _channeltype31 text DEFAULT ''::text, IN _channeltype32 text DEFAULT ''::text, IN _channeltype33 text DEFAULT ''::text, IN _channeltype34 text DEFAULT ''::text, IN _channeltype35 text DEFAULT ''::text, IN _comment1 text DEFAULT ''::text, IN _comment2 text DEFAULT ''::text, IN _comment3 text DEFAULT ''::text, IN _comment4 text DEFAULT ''::text, IN _comment5 text DEFAULT ''::text, IN _comment6 text DEFAULT ''::text, IN _comment7 text DEFAULT ''::text, IN _comment8 text DEFAULT ''::text, IN _comment9 text DEFAULT ''::text, IN _comment10 text DEFAULT ''::text, IN _comment11 text DEFAULT ''::text, IN _comment12 text DEFAULT ''::text, IN _comment13 text DEFAULT ''::text, IN _comment14 text DEFAULT ''::text, IN _comment15 text DEFAULT ''::text, IN _comment16 text DEFAULT ''::text, IN _comment17 text DEFAULT ''::text, IN _comment18 text DEFAULT ''::text, IN _mode text DEFAULT 'add'::text, INOUT _message text DEFAULT ''::text, INOUT _returncode text DEFAULT ''::text, IN _callinguser text DEFAULT ''::text)
    LANGUAGE plpgsql
    AS $$
/****************************************************
**
...
**    _expIdChannel 1 ... 35    Channel experiment: Experiment ID, Experiment Name, or ExpID:ExperimentName
**    _channelType  1 ... 35    Channel type: Normal, Reference, or Empty
...
**          02/18/2026 mem - Add support for 35-plex TMT (comments are limited to the first 18 channels since PostgreSQL procedures cannot have more than 100 parameters, and this procedure would have 111 parameters if comments could be defined for all 35 ions)
**
*****************************************************/
DECLARE
    _currentSchema text;
...
BEGIN
    ...
    BEGIN
        ...
        If Coalesce(_expectedChannelCount, 0) = 0 Or _actualChannelCount < _expectedChannelCount Then
            ...
            INSERT INTO Tmp_Experiment_Plex_Members_From_Params VALUES (19, _expIdChannel19, _channelType19, '');
            INSERT INTO Tmp_Experiment_Plex_Members_From_Params VALUES (20, _expIdChannel20, _channelType20, '');
            INSERT INTO Tmp_Experiment_Plex_Members_From_Params VALUES (21, _expIdChannel21, _channelType21, '');
            INSERT INTO Tmp_Experiment_Plex_Members_From_Params VALUES (22, _expIdChannel22, _channelType22, '');
            INSERT INTO Tmp_Experiment_Plex_Members_From_Params VALUES (23, _expIdChannel23, _channelType23, '');
            INSERT INTO Tmp_Experiment_Plex_Members_From_Params VALUES (24, _expIdChannel24, _channelType24, '');
            INSERT INTO Tmp_Experiment_Plex_Members_From_Params VALUES (25, _expIdChannel25, _channelType25, '');
            INSERT INTO Tmp_Experiment_Plex_Members_From_Params VALUES (26, _expIdChannel26, _channelType26, '');
            INSERT INTO Tmp_Experiment_Plex_Members_From_Params VALUES (27, _expIdChannel27, _channelType27, '');
            INSERT INTO Tmp_Experiment_Plex_Members_From_Params VALUES (28, _expIdChannel28, _channelType28, '');
            INSERT INTO Tmp_Experiment_Plex_Members_From_Params VALUES (29, _expIdChannel29, _channelType29, '');
            INSERT INTO Tmp_Experiment_Plex_Members_From_Params VALUES (30, _expIdChannel30, _channelType30, '');
            INSERT INTO Tmp_Experiment_Plex_Members_From_Params VALUES (31, _expIdChannel31, _channelType31, '');
            INSERT INTO Tmp_Experiment_Plex_Members_From_Params VALUES (32, _expIdChannel32, _channelType32, '');
            INSERT INTO Tmp_Experiment_Plex_Members_From_Params VALUES (33, _expIdChannel33, _channelType33, '');
            INSERT INTO Tmp_Experiment_Plex_Members_From_Params VALUES (34, _expIdChannel34, _channelType34, '');
            INSERT INTO Tmp_Experiment_Plex_Members_From_Params VALUES (35, _expIdChannel35, _channelType35, '');

            FOR _channelNum IN 1 .. 35
            LOOP
                If Exists (SELECT Channel FROM Tmp_Experiment_Plex_Members WHERE Channel = _channelNum) Then
...
ALTER PROCEDURE public.add_update_experiment_plex_members(INOUT _plexexperimentidorname text, IN _plexmembers text, IN _expidchannel1 text, IN _expidchannel2 text, IN _expidchannel3 text, IN _expidchannel4 text, IN _expidchannel5 text, IN _expidchannel6 text, IN _expidchannel7 text, IN _expidchannel8 text, IN _expidchannel9 text, IN _expidchannel10 text, IN _expidchannel11 text, IN _expidchannel12 text, IN _expidchannel13 text, IN _expidchannel14 text, IN _expidchannel15 text, IN _expidchannel16 text, IN _expidchannel17 text, IN _expidchannel18 text, IN _expidchannel19 text, IN _expidchannel20 text, IN _expidchannel21 text, IN _expidchannel22 text, IN _expidchannel23 text, IN _expidchannel24 text, IN _expidchannel25 text, IN _expidchannel26 text, IN _expidchannel27 text, IN _expidchannel28 text, IN _expidchannel29 text, IN _expidchannel30 text, IN _expidchannel31 text, IN _expidchannel32 text, IN _expidchannel33 text, IN _expidchannel34 text, IN _expidchannel35 text, IN _channeltype1 text, IN _channeltype2 text, IN _channeltype3 text, IN _channeltype4 text, IN _channeltype5 text, IN _channeltype6 text, IN _channeltype7 text, IN _channeltype8 text, IN _channeltype9 text, IN _channeltype10 text, IN _channeltype11 text, IN _channeltype12 text, IN _channeltype13 text, IN _channeltype14 text, IN _channeltype15 text, IN _channeltype16 text, IN _channeltype17 text, IN _channeltype18 text, IN _channeltype19 text, IN _channeltype20 text, IN _channeltype21 text, IN _channeltype22 text, IN _channeltype23 text, IN _channeltype24 text, IN _channeltype25 text, IN _channeltype26 text, IN _channeltype27 text, IN _channeltype28 text, IN _channeltype29 text, IN _channeltype30 text, IN _channeltype31 text, IN _channeltype32 text, IN _channeltype33 text, IN _channeltype34 text, IN _channeltype35 text, IN _comment1 text, IN _comment2 text, IN _comment3 text, IN _comment4 text, IN _comment5 text, IN _comment6 text, IN _comment7 text, IN _comment8 text, IN _comment9 text, IN _comment10 text, IN _comment11 text, IN _comment12 text, IN _comment13 text, IN _comment14 text, IN _comment15 text, IN _comment16 text, IN _comment17 text, IN _comment18 text, IN _mode text, INOUT _message text, INOUT _returncode text, IN _callinguser text) OWNER TO d3l243;
