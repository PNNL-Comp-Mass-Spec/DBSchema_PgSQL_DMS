...
CREATE VIEW public.v_campaign_entry AS
 SELECT c.campaign,
    ...
    public.get_campaign_role_person_list(c.campaign_id, 'Dataset Acquisition'::public.citext, 'PRN'::public.citext) AS dataset_acquisition_staff,
    public.get_campaign_role_person_list(c.campaign_id, 'Informatics'::public.citext, 'PRN'::public.citext) AS informatics_staff,
