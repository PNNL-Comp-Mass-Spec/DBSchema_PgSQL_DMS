...
96	43 1/4 * * *	Every 4 hours, starting at 1:43 AM
...
95	39 4 * * 7	Weekly, on Sunday at 4:39 AM
...
SELECT pg_catalog.setval('timetable.t_cron_interval_interval_id_seq', 96, true);
