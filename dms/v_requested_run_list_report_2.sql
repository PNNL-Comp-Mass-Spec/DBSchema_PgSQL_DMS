...
COMMENT ON VIEW public.v_requested_run_list_report_2 IS 'If the requested run is active, but the charge code is inactive, return 10 for #WPActivationState';
