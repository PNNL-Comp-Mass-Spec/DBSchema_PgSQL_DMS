...
CREATE OR REPLACE PROCEDURE public.lookup_instrument_run_info_from_experiment_sample_prep(IN _experimentname text, INOUT _instrumentgroup text DEFAULT ''::text, INOUT _datasettype text DEFAULT ''::text, INOUT _instrumentsettings text DEFAULT ''::text, INOUT _secsep text DEFAULT ''::text, INOUT _message text DEFAULT ''::text, INOUT _returncode text DEFAULT ''::text)
    LANGUAGE plpgsql
    AS $$
/****************************************************
**
...
**    _secSep               Input/Output: LC separation type
...
ALTER PROCEDURE public.lookup_instrument_run_info_from_experiment_sample_prep(IN _experimentname text, INOUT _instrumentgroup text, INOUT _datasettype text, INOUT _instrumentsettings text, INOUT _secsep text, INOUT _message text, INOUT _returncode text) OWNER TO d3l243;

--
-- Name: PROCEDURE lookup_instrument_run_info_from_experiment_sample_prep(IN _experimentname text, INOUT _instrumentgroup text, INOUT _datasettype text, INOUT _instrumentsettings text, INOUT _secsep text, INOUT _message text, INOUT _returncode text); Type: COMMENT; Schema: public; Owner: d3l243
--

COMMENT ON PROCEDURE public.lookup_instrument_run_info_from_experiment_sample_prep(IN _experimentname text, INOUT _instrumentgroup text, INOUT _datasettype text, INOUT _instrumentsettings text, INOUT _secsep text, INOUT _message text, INOUT _returncode text) IS 'LookupInstrumentRunInfoFromExperimentSamplePrep';
