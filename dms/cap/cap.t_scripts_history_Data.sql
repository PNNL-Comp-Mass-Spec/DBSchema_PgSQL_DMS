...
30	13	LCDatasetCapture	LCD	\N	2023-10-27 15:46:42.001343	d3l243
31	13	LCDatasetCapture	LCD	<JobScript Name="LCDatasetCapture"><Step Number="1" Tool="LCDatasetCapture" /><Step Number="2" Tool="DatasetIntegrity"><Depends_On Step_Number="1" /></Step><Step Number="3" Tool="LCDatasetInfo"><Depends_On Step_Number="2" /></Step></JobScript>	2023-10-27 15:47:06.705735	d3l243
32	12	Deleted: MyEMSLVerify	DSV	<JobScript Name="MyEMSLVerify"><Step Number="1" Tool="ArchiveStatusCheck" /></JobScript>	2023-11-02 16:52:45.915057	d3l243
33	13	Deleted: LCDatasetCapture	LCD	<JobScript Name="LCDatasetCapture"><Step Number="1" Tool="LCDatasetCapture" /><Step Number="2" Tool="DatasetIntegrity"><Depends_On Step_Number="1" /></Step><Step Number="3" Tool="LCDatasetInfo"><Depends_On Step_Number="2" /></Step></JobScript>	2023-11-02 16:52:45.915057	d3l243
34	12	MyEMSLVerify	DSV	<JobScript Name="MyEMSLVerify"><Step Number="1" Tool="ArchiveStatusCheck" /></JobScript>	2023-11-02 16:54:21.57963	d3l243
35	13	LCDatasetCapture	LCD	<JobScript Name="LCDatasetCapture"><Step Number="1" Tool="LCDatasetCapture" /><Step Number="2" Tool="DatasetIntegrity"><Depends_On Step_Number="1" Test="Target_Skipped" /></Step><Step Number="3" Tool="LCDatasetInfo"><Depends_On Step_Number="2" Test="Target_Skipped" /></Step></JobScript>	2023-11-02 16:54:49.836193	d3l243
\.
...
SELECT pg_catalog.setval('cap.t_scripts_history_entry_id_seq', 35, true);
