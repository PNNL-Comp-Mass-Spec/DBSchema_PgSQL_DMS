...
ALTER TABLE cap.t_task_step_dependencies CLUSTER ON pk_t_task_step_dependencies;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE cap.t_task_step_dependencies TO writeaccess;
