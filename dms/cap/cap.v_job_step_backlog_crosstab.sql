--
-- Name: v_job_step_backlog_crosstab; Type: VIEW; Schema: cap; Owner: d3l243
--

CREATE VIEW cap.v_job_step_backlog_crosstab AS
 SELECT ct.posting_time,
   ...
   FROM public.crosstab('SELECT date_trunc(''minute'', posting_time) AS posting_time,
           step_tool,
           backlog_count
    FROM cap.V_Job_Step_Backlog_History
...
ALTER TABLE cap.v_job_step_backlog_crosstab OWNER TO d3l243;
