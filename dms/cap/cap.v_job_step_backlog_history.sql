--
-- Name: v_job_step_backlog_history; Type: VIEW; Schema: cap; Owner: d3l243
--

CREATE VIEW cap.v_job_step_backlog_history AS
...
ALTER TABLE cap.v_job_step_backlog_history OWNER TO d3l243;
