...
CREATE VIEW public.v_entity_users_one_year AS
 SELECT 'Analysis job owner'::public.citext AS entity,
...
UNION
 SELECT 'Analysis job request user'::public.citext AS entity,
    u.username,
    count(*) AS items
  ...
  GROUP BY u.username
UNION
 SELECT 'Biomaterial contact'::public.citext AS entity,
...
UNION
 SELECT 'Dataset operator'::public.citext AS entity,
...
UNION
 SELECT 'Experiment group researcher'::public.citext AS entity,
...
UNION
 SELECT 'Experiment researcher'::public.citext AS entity,
...
UNION
 SELECT 'Cart config entered'::public.citext AS entity,
...
UNION
 SELECT 'Cart config updated'::public.citext AS entity,
...
UNION
 SELECT 'LC column operator'::public.citext AS entity,
...
UNION
 SELECT 'Reference compount contact'::public.citext AS entity,
...
UNION
 SELECT 'Requested run requester'::public.citext AS entity,
...
UNION
 SELECT 'Requested run updater'::public.citext AS entity,
...
UNION
 SELECT countq.entity,
   ...
   FROM ( SELECT 'Analysis job state change in sw.t_jobs'::public.citext AS entity,
...
UNION
 SELECT 'Analysis job owner in sw.t_jobs'::public.citext AS entity,
...
UNION
 SELECT 'Procedure usage in sw schema'::public.citext AS entity,
...
UNION
 SELECT 'Capture task state change in cap.t_tasks'::public.citext AS entity,
...
UNION
 SELECT 'Data package owner'::public.citext AS entity,
...
UNION
 SELECT 'Data package requester'::public.citext AS entity,
...
UNION
 SELECT (replaceq.entity)::public.citext AS entity,
        CASE
  ...
  GROUP BY replaceq.entity,
        ...
        END
UNION
 SELECT 'Requested run batch user'::public.citext AS entity,
    u.username,
    count(*) AS items
  ...
  GROUP BY u.username
UNION
 SELECT 'Requested run batch group user'::public.citext AS entity,
    u.username,
    count(*) AS items
  ...
  GROUP BY u.username
UNION
 SELECT 'Sample prep request requester'::public.citext AS entity,
 ...
 SELECT matchq.entity,
   ...
   FROM ( SELECT splitq.entity,
           ...
           FROM ( SELECT countq.entity,
                    ...
                    countq.items
                   FROM ( SELECT 'Sample prep request personnel'::public.citext AS entity,
...
UNION
 SELECT 'Sample submission receiver'::public.citext AS entity,
    u.username,
    count(*) AS items
  ...
  GROUP BY u.username
UNION
 SELECT 'New user'::public.citext AS entity,
    t_users.username,
    count(*) AS items
   FROM public.t_users
