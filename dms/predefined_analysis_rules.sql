...
BEGIN
    ...
    CREATE TEMP TABLE Tmp_PredefineRuleEval (
        ...
        Dataset_Exclusion         citext NULL,
        Dataset_Type              citext NULL,
        Scan_Type_Criteria        citext NOT NULL,
        Scan_Type_Exclusion       citext NOT NULL,
    ...
    INSERT INTO Tmp_PredefineRuleEval (
        ...
        Experiment_Criteria, Experiment_Exclusion, Exp_Comment_Criteria,
        Organism_Criteria,
        Dataset_Criteria, Dataset_Exclusion, Dataset_Type,
        Scan_Type_Criteria, Scan_Type_Exclusion,
    ...
    SELECT C.predefine_level, C.predefine_sequence, C.predefine_id, C.next_level,
           ...
           C.experiment_name_criteria, C.experiment_excl_criteria, C.exp_comment_criteria,
           C.organism_name_criteria,
           C.dataset_name_criteria, C.dataset_excl_criteria, C.dataset_type_criteria,
           C.scan_type_criteria, C.scan_type_excl_criteria,
