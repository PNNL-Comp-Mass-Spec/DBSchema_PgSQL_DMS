...
CREATE TRIGGER trig_t_predefined_analysis_after_update AFTER UPDATE ON public.t_predefined_analysis FOR EACH ROW WHEN (((old.analysis_tool_name OPERATOR(public.<>) new.analysis_tool_name) OR (old.campaign_excl_criteria OPERATOR(public.<>) new.campaign_excl_criteria) OR (old.campaign_name_criteria OPERATOR(public.<>) new.campaign_name_criteria) OR (old.dataset_excl_criteria OPERATOR(public.<>) new.dataset_excl_criteria) OR (old.dataset_name_criteria OPERATOR(public.<>) new.dataset_name_criteria) OR (old.dataset_type_criteria OPERATOR(public.<>) new.dataset_type_criteria) OR (old.enabled <> new.enabled) OR (old.exp_comment_criteria OPERATOR(public.<>) new.exp_comment_criteria) OR (old.experiment_excl_criteria OPERATOR(public.<>) new.experiment_excl_criteria) OR (old.experiment_name_criteria OPERATOR(public.<>) new.experiment_name_criteria) OR (old.instrument_class_criteria OPERATOR(public.<>) new.instrument_class_criteria) OR (old.instrument_name_criteria OPERATOR(public.<>) new.instrument_name_criteria) OR (old.instrument_excl_criteria OPERATOR(public.<>) new.instrument_excl_criteria) OR (old.labelling_excl_criteria OPERATOR(public.<>) new.labelling_excl_criteria) OR (old.labelling_incl_criteria OPERATOR(public.<>) new.labelling_incl_criteria) OR (old.organism_db_name OPERATOR(public.<>) new.organism_db_name) OR (old.organism_id <> new.organism_id) OR (old.organism_name_criteria OPERATOR(public.<>) new.organism_name_criteria) OR (old.param_file_name OPERATOR(public.<>) new.param_file_name) OR (old.predefine_level <> new.predefine_level) OR (old.propagation_mode <> new.propagation_mode) OR (old.priority <> new.priority) OR (old.protein_collection_list OPERATOR(public.<>) new.protein_collection_list) OR (old.protein_options_list OPERATOR(public.<>) new.protein_options_list) OR (old.scan_count_min_criteria <> new.scan_count_min_criteria) OR (old.scan_count_max_criteria <> new.scan_count_max_criteria) OR (old.separation_type_criteria OPERATOR(public.<>) new.separation_type_criteria) OR (old.trigger_before_disposition <> new.trigger_before_disposition) OR (old.next_level IS DISTINCT FROM new.next_level) OR (old.predefine_sequence IS DISTINCT FROM new.predefine_sequence) OR ((old.settings_file_name)::text IS DISTINCT FROM (new.settings_file_name)::text) OR ((old.special_processing)::text IS DISTINCT FROM (new.special_processing)::text))) EXECUTE FUNCTION public.trigfn_t_predefined_analysis_after_update();
