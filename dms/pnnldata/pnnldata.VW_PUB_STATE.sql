...
ALTER FOREIGN TABLE pnnldata."VW_PUB_STATE" ALTER COLUMN "COUNTRY_ID" OPTIONS (
    column_name 'COUNTRY_ID'
);
ALTER FOREIGN TABLE pnnldata."VW_PUB_STATE" ALTER COLUMN "STATE_CD" OPTIONS (
    column_name 'STATE_CD'
);
ALTER FOREIGN TABLE pnnldata."VW_PUB_STATE" ALTER COLUMN "STATE_NAME" OPTIONS (
    column_name 'STATE_NAME'
);
ALTER FOREIGN TABLE pnnldata."VW_PUB_STATE" ALTER COLUMN "STATE_LOC" OPTIONS (
