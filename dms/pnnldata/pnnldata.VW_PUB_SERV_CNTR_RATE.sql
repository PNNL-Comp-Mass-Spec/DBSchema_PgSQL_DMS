...
ALTER FOREIGN TABLE ONLY pnnldata."VW_PUB_SERV_CNTR_RATE" ALTER COLUMN "SNDR_SUBACCT" OPTIONS (
    column_name 'SNDR_SUBACCT'
);
ALTER FOREIGN TABLE ONLY pnnldata."VW_PUB_SERV_CNTR_RATE" ALTER COLUMN "TOS" OPTIONS (
    column_name 'TOS'
);
ALTER FOREIGN TABLE ONLY pnnldata."VW_PUB_SERV_CNTR_RATE" ALTER COLUMN "EFF_DATE" OPTIONS (
    column_name 'EFF_DATE'
);
ALTER FOREIGN TABLE ONLY pnnldata."VW_PUB_SERV_CNTR_RATE" ALTER COLUMN "INACT_DATE" OPTIONS (
    column_name 'INACT_DATE'
);
ALTER FOREIGN TABLE ONLY pnnldata."VW_PUB_SERV_CNTR_RATE" ALTER COLUMN "SERV_RATE" OPTIONS (
    column_name 'SERV_RATE'
);
ALTER FOREIGN TABLE ONLY pnnldata."VW_PUB_SERV_CNTR_RATE" ALTER COLUMN "LAST_CHANGE_DATE" OPTIONS (
    column_name 'LAST_CHANGE_DATE'
);
ALTER FOREIGN TABLE ONLY pnnldata."VW_PUB_SERV_CNTR_RATE" ALTER COLUMN "LAST_CHANGE_ID" OPTIONS (
