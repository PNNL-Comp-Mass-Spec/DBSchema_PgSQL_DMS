...
ALTER FOREIGN TABLE pnnldata."VW_PUB_COUNTRY" ALTER COLUMN "CTRY_CD" OPTIONS (
    column_name 'CTRY_CD'
);
ALTER FOREIGN TABLE pnnldata."VW_PUB_COUNTRY" ALTER COLUMN "CTRY_NAME" OPTIONS (
    column_name 'CTRY_NAME'
);
ALTER FOREIGN TABLE pnnldata."VW_PUB_COUNTRY" ALTER COLUMN "FIPS_CTRY_CD" OPTIONS (
    column_name 'FIPS_CTRY_CD'
);
ALTER FOREIGN TABLE pnnldata."VW_PUB_COUNTRY" ALTER COLUMN "OPEN_CTRY_SW" OPTIONS (
    column_name 'OPEN_CTRY_SW'
);
ALTER FOREIGN TABLE pnnldata."VW_PUB_COUNTRY" ALTER COLUMN "PRIMARY_REGION_CD" OPTIONS (
