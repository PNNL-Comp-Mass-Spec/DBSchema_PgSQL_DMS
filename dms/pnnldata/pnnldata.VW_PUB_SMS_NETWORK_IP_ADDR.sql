...
ALTER FOREIGN TABLE ONLY pnnldata."VW_PUB_SMS_NETWORK_IP_ADDR" ALTER COLUMN "SMS_DEVICE_ID" OPTIONS (
    column_name 'SMS_DEVICE_ID'
);
ALTER FOREIGN TABLE ONLY pnnldata."VW_PUB_SMS_NETWORK_IP_ADDR" ALTER COLUMN "IP_ADDRESS" OPTIONS (
    column_name 'IP_ADDRESS'
);
ALTER FOREIGN TABLE ONLY pnnldata."VW_PUB_SMS_NETWORK_IP_ADDR" ALTER COLUMN "PHYSICAL_ADDRESS" OPTIONS (
    column_name 'PHYSICAL_ADDRESS'
);
ALTER FOREIGN TABLE ONLY pnnldata."VW_PUB_SMS_NETWORK_IP_ADDR" ALTER COLUMN "LAST_SEEN_DTM" OPTIONS (
    column_name 'LAST_SEEN_DTM'
);
ALTER FOREIGN TABLE ONLY pnnldata."VW_PUB_SMS_NETWORK_IP_ADDR" ALTER COLUMN "DW_ACQ_DATETIME" OPTIONS (
