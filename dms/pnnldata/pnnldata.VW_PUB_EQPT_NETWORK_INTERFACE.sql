...
ALTER FOREIGN TABLE ONLY pnnldata."VW_PUB_EQPT_NETWORK_INTERFACE" ALTER COLUMN "EQPT_GUID" OPTIONS (
    column_name 'EQPT_GUID'
);
ALTER FOREIGN TABLE ONLY pnnldata."VW_PUB_EQPT_NETWORK_INTERFACE" ALTER COLUMN "MAC_ADDRESS" OPTIONS (
    column_name 'MAC_ADDRESS'
);
ALTER FOREIGN TABLE ONLY pnnldata."VW_PUB_EQPT_NETWORK_INTERFACE" ALTER COLUMN "INTERFACE_NAME" OPTIONS (
    column_name 'INTERFACE_NAME'
);
ALTER FOREIGN TABLE ONLY pnnldata."VW_PUB_EQPT_NETWORK_INTERFACE" ALTER COLUMN "DHCP_SERVER_IP_ADDRESS" OPTIONS (
    column_name 'DHCP_SERVER_IP_ADDRESS'
);
ALTER FOREIGN TABLE ONLY pnnldata."VW_PUB_EQPT_NETWORK_INTERFACE" ALTER COLUMN "DEFAULT_GATEWAY_IP_ADDRESS" OPTIONS (
    column_name 'DEFAULT_GATEWAY_IP_ADDRESS'
);
ALTER FOREIGN TABLE ONLY pnnldata."VW_PUB_EQPT_NETWORK_INTERFACE" ALTER COLUMN "ACTIVE_SW" OPTIONS (
    column_name 'ACTIVE_SW'
);
ALTER FOREIGN TABLE ONLY pnnldata."VW_PUB_EQPT_NETWORK_INTERFACE" ALTER COLUMN "ENTRY_DATETIME" OPTIONS (
    column_name 'ENTRY_DATETIME'
);
ALTER FOREIGN TABLE ONLY pnnldata."VW_PUB_EQPT_NETWORK_INTERFACE" ALTER COLUMN "UPDATE_DATETIME" OPTIONS (
