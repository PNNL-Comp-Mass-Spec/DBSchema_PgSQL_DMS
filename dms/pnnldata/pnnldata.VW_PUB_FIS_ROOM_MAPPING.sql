...
ALTER FOREIGN TABLE ONLY pnnldata."VW_PUB_FIS_ROOM_MAPPING" ALTER COLUMN "FIS_FACILITY_ID" OPTIONS (
    column_name 'FIS_FACILITY_ID'
);
ALTER FOREIGN TABLE ONLY pnnldata."VW_PUB_FIS_ROOM_MAPPING" ALTER COLUMN "FIS_SPACE_ID" OPTIONS (
    column_name 'FIS_SPACE_ID'
);
ALTER FOREIGN TABLE ONLY pnnldata."VW_PUB_FIS_ROOM_MAPPING" ALTER COLUMN "BLDG_NO" OPTIONS (
    column_name 'BLDG_NO'
);
ALTER FOREIGN TABLE ONLY pnnldata."VW_PUB_FIS_ROOM_MAPPING" ALTER COLUMN "ROOM_NO" OPTIONS (
    column_name 'ROOM_NO'
);
