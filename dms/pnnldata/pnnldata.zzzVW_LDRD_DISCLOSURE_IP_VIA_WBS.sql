...
ALTER FOREIGN TABLE ONLY pnnldata."zzzVW_LDRD_DISCLOSURE_IP_VIA_WBS" ALTER COLUMN "IP_ID" OPTIONS (
    column_name 'IP_ID'
);
ALTER FOREIGN TABLE ONLY pnnldata."zzzVW_LDRD_DISCLOSURE_IP_VIA_WBS" ALTER COLUMN "MASTER_ID" OPTIONS (
    column_name 'MASTER_ID'
);
ALTER FOREIGN TABLE ONLY pnnldata."zzzVW_LDRD_DISCLOSURE_IP_VIA_WBS" ALTER COLUMN "TITLE" OPTIONS (
    column_name 'TITLE'
);
ALTER FOREIGN TABLE ONLY pnnldata."zzzVW_LDRD_DISCLOSURE_IP_VIA_WBS" ALTER COLUMN "SUBMITTED_DATE" OPTIONS (
    column_name 'SUBMITTED_DATE'
);
ALTER FOREIGN TABLE ONLY pnnldata."zzzVW_LDRD_DISCLOSURE_IP_VIA_WBS" ALTER COLUMN "IP_TYPE_DESC" OPTIONS (
    column_name 'IP_TYPE_DESC'
);
ALTER FOREIGN TABLE ONLY pnnldata."zzzVW_LDRD_DISCLOSURE_IP_VIA_WBS" ALTER COLUMN "WBS" OPTIONS (
    column_name 'WBS'
);
