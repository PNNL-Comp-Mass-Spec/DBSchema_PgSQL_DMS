--
-- Name: v_lc_column_list_report; Type: VIEW; Schema: public; Owner: d3l243
--
...
ALTER TABLE public.v_lc_column_list_report OWNER TO d3l243;

--
-- Name: TABLE v_lc_column_list_report; Type: ACL; Schema: public; Owner: d3l243
--

GRANT SELECT ON TABLE public.v_lc_column_list_report TO readaccess;
GRANT SELECT ON TABLE public.v_lc_column_list_report TO writeaccess;
