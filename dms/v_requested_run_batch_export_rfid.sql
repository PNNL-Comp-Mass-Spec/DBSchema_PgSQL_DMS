...
COMMENT ON VIEW public.v_requested_run_batch_export_rfid IS 'Requests is total requested runs in the batch. Active_Requests is the number of active requested runs in the batch (no dataset yet)';
