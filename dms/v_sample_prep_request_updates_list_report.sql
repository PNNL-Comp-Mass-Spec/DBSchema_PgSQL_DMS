...
ALTER VIEW public.v_sample_prep_request_updates_list_report OWNER TO d3l243;
...
GRANT SELECT ON TABLE public.v_sample_prep_request_updates_list_report TO writeaccess;
