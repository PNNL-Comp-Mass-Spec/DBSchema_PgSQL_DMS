...
21	bruker_tof_tsf	1	.tsf	Imaging - directory with .jpg and .mis files, and .D directory with a .tsf file and a .tsf_bin file
\.
...
SELECT pg_catalog.setval('public.t_instrument_data_type_name_raw_data_type_id_seq', 21, true);
