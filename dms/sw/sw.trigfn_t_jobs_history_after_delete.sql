--
-- Name: trigfn_t_jobs_history_after_delete(); Type: FUNCTION; Schema: sw; Owner: d3l243
--

CREATE OR REPLACE FUNCTION sw.trigfn_t_jobs_history_after_delete() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
/****************************************************
**
...
ALTER FUNCTION sw.trigfn_t_jobs_history_after_delete() OWNER TO d3l243;
