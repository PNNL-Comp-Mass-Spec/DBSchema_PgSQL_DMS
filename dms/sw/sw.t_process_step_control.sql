...
ALTER TABLE sw.t_process_step_control CLUSTER ON pk_t_process_step_control;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE sw.t_process_step_control TO writeaccess;
