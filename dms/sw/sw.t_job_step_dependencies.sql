...
ALTER TABLE sw.t_job_step_dependencies CLUSTER ON pk_t_job_step_dependencies;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE sw.t_job_step_dependencies TO writeaccess;
