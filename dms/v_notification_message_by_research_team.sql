...
CREATE VIEW public.v_notification_message_by_research_team AS
 SELECT v_notification_requested_run_batches_by_research_team.seq,
    ...
    v_notification_requested_run_batches_by_research_team."#EntityType",
...
UNION
 SELECT v_notification_analysis_job_request_by_research_team.seq,
    ...
    v_notification_analysis_job_request_by_research_team."#EntityType",
...
UNION
 SELECT v_notification_sample_prep_request_by_research_team.seq,
    ...
    v_notification_sample_prep_request_by_research_team."#EntityType",
...
UNION
 SELECT v_notification_datasets_by_research_team.seq,
    ...
    v_notification_datasets_by_research_team."#EntityType",
...
ALTER TABLE public.v_notification_message_by_research_team OWNER TO d3l243;
