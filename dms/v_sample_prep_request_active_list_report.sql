...
COMMENT ON VIEW public.v_sample_prep_request_active_list_report IS 'If the request is not closed, but the charge code is inactive, return 10 for #WPActivationState';
