...
ALTER TABLE public.t_biomaterial_organisms CLUSTER ON pk_t_biomaterial_organisms;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.t_biomaterial_organisms TO writeaccess;
