...
COMMENT ON VIEW public.v_user_list_report_2 IS 'Note that some DMS Users have multiple EUS Person_ID values; that leads to duplicate rows in this report, but it doesn"t hurt anything (and is actually informative)';
