...
CREATE VIEW public.v_experiment_plex_members_detail_report AS
 SELECT plexmembers.plex_exp_id AS exp_id,
  ...
  GROUP BY plexmembers.plex_exp_id, e.experiment, u.name_with_username, org.organism, e.reason, e.comment, e.created, c.campaign, bto.term_name, e.labelling, e.alkylation, e.sample_prep_request_id, bto.identifier, ces.dataset_count, ces.most_recent_dataset, ces.factor_count, e.exp_id, mc.container, ml.location, e.material_active, e.last_used, e.barcode;
