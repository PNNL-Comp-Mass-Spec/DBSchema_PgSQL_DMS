...
ALTER TABLE logcap.t_task_step_events CLUSTER ON pk_t_task_step_events;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE logcap.t_task_step_events TO writeaccess;
