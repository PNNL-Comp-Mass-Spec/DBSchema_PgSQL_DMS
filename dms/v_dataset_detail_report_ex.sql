...
CREATE VIEW public.v_dataset_detail_report_ex AS
 SELECT ds.dataset,
    ...
    scrs.svc_center_report_state AS service_center_report_state,
   ...
   FROM ((((((((((((((((ont.t_cv_bto_cached_names bto
     ...
     JOIN public.t_dataset_svc_center_report_state scrs ON ((ds.svc_center_report_state_id = scrs.svc_center_report_state_id)))
