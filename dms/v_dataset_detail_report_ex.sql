...
CREATE VIEW public.v_dataset_detail_report_ex AS
 SELECT ds.dataset,
    ...
    COALESCE(public.get_acq_length_minutes(ds.acq_time_start, ds.acq_time_end), ds.acq_length_minutes) AS acq_length_minutes,
    ...
    repstate.svc_center_report_state AS service_center_report_state,
