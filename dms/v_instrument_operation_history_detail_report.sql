...
ALTER VIEW public.v_instrument_operation_history_detail_report OWNER TO d3l243;
...
GRANT SELECT ON TABLE public.v_instrument_operation_history_detail_report TO writeaccess;
