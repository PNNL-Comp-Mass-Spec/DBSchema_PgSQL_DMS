...
CREATE VIEW public.v_service_cost_rate_list_report AS
 SELECT cr.cost_group_id,
    ...
    t.service_type,
    cr.service_type_id,
    cr.doe_burdened_rate_per_run AS doe_rate,
    cr.hhs_burdened_rate_per_run AS hhs_rate,
    cr.ldrd_burdened_rate_per_run AS ldrd_rate
  ...
  WHERE (cg.service_cost_state_id = 2);
