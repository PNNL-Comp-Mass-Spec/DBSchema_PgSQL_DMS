...
COMMENT ON VIEW public.v_rna_prep_request_detail_report IS 'If the request is not closed, but the charge code is inactive, return 10 for #WPActivationState';
