...
ALTER TABLE dpkg.t_data_package_type CLUSTER ON pk_t_data_package_type;

--
-- Name: TABLE t_data_package_type; Type: ACL; Schema: dpkg; Owner: d3l243
--

GRANT SELECT ON TABLE dpkg.t_data_package_type TO readaccess;
GRANT SELECT ON TABLE dpkg.t_data_package_type TO writeaccess;
