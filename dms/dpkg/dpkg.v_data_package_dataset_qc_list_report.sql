--
-- Name: v_data_package_dataset_qc_list_report; Type: VIEW; Schema: dpkg; Owner: d3l243
--

CREATE VIEW dpkg.v_data_package_dataset_qc_list_report AS
 SELECT dpd.data_pkg_id,
   ...
   FROM (((((((((((public.t_dataset ds
     ...
     JOIN dpkg.t_data_package_datasets dpd ON ((ds.dataset_id = dpd.dataset_id)))
...
ALTER VIEW dpkg.v_data_package_dataset_qc_list_report OWNER TO d3l243;

--
-- Name: TABLE v_data_package_dataset_qc_list_report; Type: ACL; Schema: dpkg; Owner: d3l243
--

GRANT SELECT ON TABLE dpkg.v_data_package_dataset_qc_list_report TO readaccess;
GRANT SELECT ON TABLE dpkg.v_data_package_dataset_qc_list_report TO writeaccess;
