...
ALTER VIEW public.v_data_analysis_request_user_picklist OWNER TO d3l243;
...
GRANT SELECT ON TABLE public.v_data_analysis_request_user_picklist TO writeaccess;
