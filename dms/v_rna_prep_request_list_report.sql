...
COMMENT ON VIEW public.v_rna_prep_request_list_report IS 'If the request is not closed, but the charge code is inactive, return 10 for wp_activation_state';
...
GRANT SELECT ON TABLE public.v_rna_prep_request_list_report TO writeaccess;
