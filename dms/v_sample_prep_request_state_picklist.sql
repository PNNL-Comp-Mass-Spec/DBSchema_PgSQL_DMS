...
ALTER VIEW public.v_sample_prep_request_state_picklist OWNER TO d3l243;
...
GRANT SELECT ON TABLE public.v_sample_prep_request_state_picklist TO writeaccess;
