...
ALTER PROCEDURE mc.enablearchivedependentmanagers(_infoonly integer, INOUT _message text, INOUT _returncode text) OWNER TO d3l243;

--
-- Name: PROCEDURE enablearchivedependentmanagers(_infoonly integer, INOUT _message text, INOUT _returncode text); Type: COMMENT; Schema: mc; Owner: d3l243
--

COMMENT ON PROCEDURE mc.enablearchivedependentmanagers(_infoonly integer, INOUT _message text, INOUT _returncode text) IS 'EnableArchiveDependentManagers';
