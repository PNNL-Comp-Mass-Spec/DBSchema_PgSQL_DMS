...
CREATE OR REPLACE PROCEDURE mc.reportmanagererrorcleanup(_managername text, _state integer DEFAULT 0, _failuremsg text DEFAULT ''::text, INOUT _message text DEFAULT ''::text, INOUT _returncode text DEFAULT ''::text)
    LANGUAGE plpgsql
    AS $$
/****************************************************
**
...
ALTER PROCEDURE mc.reportmanagererrorcleanup(_managername text, _state integer, _failuremsg text, INOUT _message text, INOUT _returncode text) OWNER TO d3l243;

--
-- Name: PROCEDURE reportmanagererrorcleanup(_managername text, _state integer, _failuremsg text, INOUT _message text, INOUT _returncode text); Type: COMMENT; Schema: mc; Owner: d3l243
--

COMMENT ON PROCEDURE mc.reportmanagererrorcleanup(_managername text, _state integer, _failuremsg text, INOUT _message text, INOUT _returncode text) IS 'ReportManagerErrorCleanup';
