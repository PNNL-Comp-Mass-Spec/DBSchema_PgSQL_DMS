...
CREATE PROCEDURE mc.enabledisablerunjobsremotely(_enable integer, _managernamelist text DEFAULT ''::text, _infoonly integer DEFAULT 0, _addmgrparamsifmissing integer DEFAULT 0, INOUT _message text DEFAULT ''::text, INOUT _returncode text DEFAULT ''::text)
    LANGUAGE plpgsql
    AS $$
/****************************************************
**
