...
CREATE OR REPLACE VIEW mc.v_mgr_type_list_by_param AS
 SELECT groupq.param_name,
   ...
   FROM ( SELECT DISTINCT pt.param_name,
           ...
           FROM (((mc.t_mgr_type_param_type_map mp
             ...
             JOIN mc.t_param_type pt ON ((mp.param_type_id = pt.param_id)))
             JOIN ( SELECT DISTINCT pt2.param_name,
                   ...
                   FROM ((mc.t_mgr_type_param_type_map mtpm
                     ...
                     JOIN mc.t_param_type pt2 ON ((mtpm.param_type_id = pt2.param_id)))) lookupq ON ((pt.param_name OPERATOR(public.=) lookupq.param_name)))) groupq
  GROUP BY groupq.param_name;


ALTER TABLE mc.v_mgr_type_list_by_param OWNER TO d3l243;
