...
ALTER PROCEDURE mc.getmanagerparameterswork(_managernamelist text, _sortmode integer, _maxrecursion integer, INOUT _message text) OWNER TO d3l243;

--
-- Name: PROCEDURE getmanagerparameterswork(_managernamelist text, _sortmode integer, _maxrecursion integer, INOUT _message text); Type: COMMENT; Schema: mc; Owner: d3l243
--

COMMENT ON PROCEDURE mc.getmanagerparameterswork(_managernamelist text, _sortmode integer, _maxrecursion integer, INOUT _message text) IS 'GetManagerParametersWork';
