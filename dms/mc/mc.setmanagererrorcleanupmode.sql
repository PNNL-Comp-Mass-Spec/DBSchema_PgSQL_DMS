...
CREATE OR REPLACE PROCEDURE mc.setmanagererrorcleanupmode(_mgrlist text DEFAULT ''::text, _cleanupmode integer DEFAULT 1, _showtable integer DEFAULT 1, _infoonly integer DEFAULT 0, INOUT _message text DEFAULT ''::text, INOUT _returncode text DEFAULT ''::text)
    LANGUAGE plpgsql
    AS $$
/****************************************************
**
...
ALTER PROCEDURE mc.setmanagererrorcleanupmode(_mgrlist text, _cleanupmode integer, _showtable integer, _infoonly integer, INOUT _message text, INOUT _returncode text) OWNER TO d3l243;

--
-- Name: PROCEDURE setmanagererrorcleanupmode(_mgrlist text, _cleanupmode integer, _showtable integer, _infoonly integer, INOUT _message text, INOUT _returncode text); Type: COMMENT; Schema: mc; Owner: d3l243
--

COMMENT ON PROCEDURE mc.setmanagererrorcleanupmode(_mgrlist text, _cleanupmode integer, _showtable integer, _infoonly integer, INOUT _message text, INOUT _returncode text) IS 'SetManagerErrorCleanupMode';
