...
CREATE OR REPLACE PROCEDURE mc.updatesinglemgrparamwork(_paramname text, _newvalue text, _callinguser text DEFAULT ''::text, INOUT _message text DEFAULT ''::text, INOUT _returncode text DEFAULT ''::text)
    LANGUAGE plpgsql
    AS $$
/****************************************************
**
...
ALTER PROCEDURE mc.updatesinglemgrparamwork(_paramname text, _newvalue text, _callinguser text, INOUT _message text, INOUT _returncode text) OWNER TO d3l243;

--
-- Name: PROCEDURE updatesinglemgrparamwork(_paramname text, _newvalue text, _callinguser text, INOUT _message text, INOUT _returncode text); Type: COMMENT; Schema: mc; Owner: d3l243
--

COMMENT ON PROCEDURE mc.updatesinglemgrparamwork(_paramname text, _newvalue text, _callinguser text, INOUT _message text, INOUT _returncode text) IS 'UpdateSingleMgrParamWork';
