...
--
-- Name: ix_t_cv_mod_grand_parent_term_name; Type: INDEX; Schema: ont; Owner: d3l243
--

CREATE INDEX ix_t_cv_mod_grand_parent_term_name ON ont.t_cv_mod USING btree (grand_parent_term_name);
