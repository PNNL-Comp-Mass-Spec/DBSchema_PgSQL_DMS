--
-- Name: v_term_hierarchy_psi_mi; Type: VIEW; Schema: ont; Owner: d3l243
--

CREATE VIEW ont.v_term_hierarchy_psi_mi AS
 WITH RECURSIVE termhierarchy AS (
         SELECT child.namespace,
          ...
          WHERE ((child.is_root_term = 1) AND (child.namespace OPERATOR(public.=) 'PSI-MI'::public.citext))
        UNION ALL
         SELECT child.namespace,
            child.term_name,
            child.identifier,
...
ALTER TABLE ont.v_term_hierarchy_psi_mi OWNER TO d3l243;

--
-- Name: VIEW v_term_hierarchy_psi_mi; Type: COMMENT; Schema: ont; Owner: d3l243
--

COMMENT ON VIEW ont.v_term_hierarchy_psi_mi IS 'This view uses a recursive query. It is elegant, but not efficient since the "T_Term" and "T_Term_Relationship" tables are so large. Use view V_CV_PSI_MI instead';

--
-- Name: TABLE v_term_hierarchy_psi_mi; Type: ACL; Schema: ont; Owner: d3l243
--
