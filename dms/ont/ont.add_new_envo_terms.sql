...
BEGIN
    ...
    If Not _infoOnly Then
        ...
        RAISE INFO 'Updated % rows in ont.t_cv_envo using %', _updateCount, _sourceTable;
        ...
        RAISE INFO 'Added % new rows to ont.t_cv_envo using %', _insertCount, _sourceTable;
        ...
        FROM (SELECT DISTINCT t.identifier, t.term_name
              ...
              GROUP BY t.identifier, t.term_name) UniqueQTarget
             LEFT OUTER JOIN
