...
ALTER TABLE ont.t_cv_pato OWNER TO d3l243;

--
-- Name: t_cv_pato_entry_id_seq; Type: SEQUENCE; Schema: ont; Owner: d3l243
--

ALTER TABLE ont.t_cv_pato ALTER COLUMN entry_id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME ont.t_cv_pato_entry_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: t_cv_pato pk_t_cv_pato; Type: CONSTRAINT; Schema: ont; Owner: d3l243
--
...
GRANT SELECT ON TABLE ont.t_cv_pato TO readaccess;
GRANT SELECT ON TABLE ont.t_cv_pato TO writeaccess;
