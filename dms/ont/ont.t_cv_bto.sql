...
ALTER TABLE ont.t_cv_bto CLUSTER ON pk_t_cv_bto;
...
--
-- Name: TABLE t_cv_bto; Type: ACL; Schema: ont; Owner: d3l243
--

GRANT SELECT ON TABLE ont.t_cv_bto TO readaccess;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE ont.t_cv_bto TO writeaccess;
