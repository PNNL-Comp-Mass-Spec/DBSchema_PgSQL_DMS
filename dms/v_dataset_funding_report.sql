...
CREATE VIEW public.v_dataset_funding_report AS
 SELECT ds.dataset_id AS id,
    ...
    (public.get_proposal_eus_users_list(rr.eus_proposal_id, 'N'::text, 5))::public.citext AS emsl_users,
    (public.get_proposal_eus_users_list(rr.eus_proposal_id, 'I'::text, 20))::public.citext AS emsl_user_ids,
    dtn.dataset_type,
