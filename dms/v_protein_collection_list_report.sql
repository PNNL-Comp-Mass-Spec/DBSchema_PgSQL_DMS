--
-- Name: v_protein_collection_list_report; Type: VIEW; Schema: public; Owner: d3l243
--

CREATE VIEW public.v_protein_collection_list_report AS
...
GRANT SELECT ON TABLE public.v_protein_collection_list_report TO readaccess;
GRANT SELECT ON TABLE public.v_protein_collection_list_report TO writeaccess;
