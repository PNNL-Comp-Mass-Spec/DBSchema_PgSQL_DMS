--
-- Name: store_job_psm_stats(integer, double precision, double precision, integer, integer, integer, integer, integer, integer, integer, smallint, real, integer, integer, integer, integer, real, real, integer, integer, integer, smallint, real, real, integer, integer, boolean, text, text); Type: PROCEDURE; Schema: public; Owner: d3l243
--

CREATE OR REPLACE PROCEDURE public.store_job_psm_stats(IN _job integer, IN _msgfthreshold double precision, IN _fdrthreshold double precision, IN _spectrasearched integer, IN _totalpsms integer, IN _uniquepeptides integer, IN _uniqueproteins integer, IN _totalpsmsfdrfilter integer DEFAULT 0, IN _uniquepeptidesfdrfilter integer DEFAULT 0, IN _uniqueproteinsfdrfilter integer DEFAULT 0, IN _msgfthresholdisevalue smallint DEFAULT 0, IN _percentmsnscansnopsm real DEFAULT 0, IN _maximumscangapadjacentmsn integer DEFAULT 0, IN _uniquephosphopeptidecountfdr integer DEFAULT 0, IN _uniquephosphopeptidesctermk integer DEFAULT 0, IN _uniquephosphopeptidesctermr integer DEFAULT 0, IN _missedcleavageratio real DEFAULT 0, IN _missedcleavageratiophospho real DEFAULT 0, IN _trypticpeptides integer DEFAULT 0, IN _keratinpeptides integer DEFAULT 0, IN _trypsinpeptides integer DEFAULT 0, IN _dynamicreporterion smallint DEFAULT 0, IN _percentpsmsmissingntermreporterion real DEFAULT 0, IN _percentpsmsmissingreporterion real DEFAULT 0, IN _uniqueacetylpeptidesfdr integer DEFAULT 0, IN _uniqueubiquitinpeptidesfdr integer DEFAULT 0, IN _infoonly boolean DEFAULT false, INOUT _message text DEFAULT ''::text, INOUT _returncode text DEFAULT ''::text)
    LANGUAGE plpgsql
    AS $$
/****************************************************
**
...
**          08/06/2024 mem - Change parameters _msgfThreshold and _fdrThreshold from real to double precision
**                         - Change parameters _msgfThresholdIsEValue and _dynamicReporterIon from int to smallint
**
*****************************************************/
DECLARE
    _datasetID int;
...
ALTER PROCEDURE public.store_job_psm_stats(IN _job integer, IN _msgfthreshold double precision, IN _fdrthreshold double precision, IN _spectrasearched integer, IN _totalpsms integer, IN _uniquepeptides integer, IN _uniqueproteins integer, IN _totalpsmsfdrfilter integer, IN _uniquepeptidesfdrfilter integer, IN _uniqueproteinsfdrfilter integer, IN _msgfthresholdisevalue smallint, IN _percentmsnscansnopsm real, IN _maximumscangapadjacentmsn integer, IN _uniquephosphopeptidecountfdr integer, IN _uniquephosphopeptidesctermk integer, IN _uniquephosphopeptidesctermr integer, IN _missedcleavageratio real, IN _missedcleavageratiophospho real, IN _trypticpeptides integer, IN _keratinpeptides integer, IN _trypsinpeptides integer, IN _dynamicreporterion smallint, IN _percentpsmsmissingntermreporterion real, IN _percentpsmsmissingreporterion real, IN _uniqueacetylpeptidesfdr integer, IN _uniqueubiquitinpeptidesfdr integer, IN _infoonly boolean, INOUT _message text, INOUT _returncode text) OWNER TO d3l243;

--
-- Name: PROCEDURE store_job_psm_stats(IN _job integer, IN _msgfthreshold double precision, IN _fdrthreshold double precision, IN _spectrasearched integer, IN _totalpsms integer, IN _uniquepeptides integer, IN _uniqueproteins integer, IN _totalpsmsfdrfilter integer, IN _uniquepeptidesfdrfilter integer, IN _uniqueproteinsfdrfilter integer, IN _msgfthresholdisevalue smallint, IN _percentmsnscansnopsm real, IN _maximumscangapadjacentmsn integer, IN _uniquephosphopeptidecountfdr integer, IN _uniquephosphopeptidesctermk integer, IN _uniquephosphopeptidesctermr integer, IN _missedcleavageratio real, IN _missedcleavageratiophospho real, IN _trypticpeptides integer, IN _keratinpeptides integer, IN _trypsinpeptides integer, IN _dynamicreporterion smallint, IN _percentpsmsmissingntermreporterion real, IN _percentpsmsmissingreporterion real, IN _uniqueacetylpeptidesfdr integer, IN _uniqueubiquitinpeptidesfdr integer, IN _infoonly boolean, INOUT _message text, INOUT _returncode text); Type: COMMENT; Schema: public; Owner: d3l243
--

COMMENT ON PROCEDURE public.store_job_psm_stats(IN _job integer, IN _msgfthreshold double precision, IN _fdrthreshold double precision, IN _spectrasearched integer, IN _totalpsms integer, IN _uniquepeptides integer, IN _uniqueproteins integer, IN _totalpsmsfdrfilter integer, IN _uniquepeptidesfdrfilter integer, IN _uniqueproteinsfdrfilter integer, IN _msgfthresholdisevalue smallint, IN _percentmsnscansnopsm real, IN _maximumscangapadjacentmsn integer, IN _uniquephosphopeptidecountfdr integer, IN _uniquephosphopeptidesctermk integer, IN _uniquephosphopeptidesctermr integer, IN _missedcleavageratio real, IN _missedcleavageratiophospho real, IN _trypticpeptides integer, IN _keratinpeptides integer, IN _trypsinpeptides integer, IN _dynamicreporterion smallint, IN _percentpsmsmissingntermreporterion real, IN _percentpsmsmissingreporterion real, IN _uniqueacetylpeptidesfdr integer, IN _uniqueubiquitinpeptidesfdr integer, IN _infoonly boolean, INOUT _message text, INOUT _returncode text) IS 'StoreJobPSMStats';
