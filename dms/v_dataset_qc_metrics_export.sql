...
CREATE VIEW public.v_dataset_qc_metrics_export AS
 SELECT instname.instrument_group,
    ...
    dqc.ms2_density_q2,
    dqc.ms2_density_q3,
    dqc.ms2_prec_z_1 AS ms2_precz_1,
    dqc.ms2_prec_z_2 AS ms2_precz_2,
    dqc.ms2_prec_z_3 AS ms2_precz_3,
    dqc.ms2_prec_z_4 AS ms2_precz_4,
    dqc.ms2_prec_z_5 AS ms2_precz_5,
    dqc.ms2_prec_z_more AS ms2_precz_more,
    dqc.ms2_prec_z_likely_1 AS ms2_precz_likely_1,
    dqc.ms2_prec_z_likely_multi AS ms2_precz_likely_multi,
    ...
    dqc.trypsin_2a,
    dqc.trypsin_2c,
    dqc.ms2_rep_ion_all AS ms2_repion_all,
    dqc.ms2_rep_ion_1missing AS ms2_repion_1missing,
    dqc.ms2_rep_ion_2missing AS ms2_repion_2missing,
    dqc.ms2_rep_ion_3missing AS ms2_repion_3missing,
    dqc.mass_error_ppm_refined AS masserrorppm_refined,
