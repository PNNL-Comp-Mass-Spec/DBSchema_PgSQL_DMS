...
ALTER VIEW public.v_analysis_job_processor_group_detail_report OWNER TO d3l243;
...
GRANT SELECT ON TABLE public.v_analysis_job_processor_group_detail_report TO writeaccess;
