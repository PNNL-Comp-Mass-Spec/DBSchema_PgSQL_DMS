...
COMMENT ON VIEW public.v_data_analysis_request_list_report IS 'If the analysis request is not closed, but the charge code is inactive, return 10 for #WPActivationState';
