...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE pc.t_protein_collection_members TO writeaccess;
GRANT INSERT,DELETE,UPDATE ON TABLE pc.t_protein_collection_members TO pceditor;
