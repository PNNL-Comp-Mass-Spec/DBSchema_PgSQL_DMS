...
CREATE OR REPLACE FUNCTION pc.get_shared_protein_ids(_collection_1 integer, _collection_2 integer) RETURNS TABLE(protein_id integer)
    LANGUAGE plpgsql
    AS $$
/****************************************************
**
...
ALTER FUNCTION pc.get_shared_protein_ids(_collection_1 integer, _collection_2 integer) OWNER TO d3l243;

--
-- Name: FUNCTION get_shared_protein_ids(_collection_1 integer, _collection_2 integer); Type: COMMENT; Schema: pc; Owner: d3l243
--

COMMENT ON FUNCTION pc.get_shared_protein_ids(_collection_1 integer, _collection_2 integer) IS 'GetSharedProteinIDs';
