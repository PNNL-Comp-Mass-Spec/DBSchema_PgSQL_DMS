--
-- Name: v_event_log; Type: VIEW; Schema: logdms; Owner: d3l243
--

CREATE VIEW logdms.v_event_log AS
 SELECT el.event_id,
    el.target_type,
        CASE el.target_type
    ...
    el.target_state,
        CASE el.target_type
            ...
            WHEN 5 THEN (ajs.job_state)::text
   ...
   FROM ((((((((logdms.t_event_log el
     ...
     LEFT JOIN public.t_analysis_job_state ajs ON (((el.target_state = ajs.job_state_id) AND (el.target_type = 5))))
