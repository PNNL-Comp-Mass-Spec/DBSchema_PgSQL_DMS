...
**
**  Desc:
**      Adds new or edits an existing data analysis request
**
...
BEGIN
    ...
    BEGIN
        ...
        ElsIf Exists (SELECT t_charge_code FROM t_charge_code WHERE charge_code = _workPackage And charge_code_state = 0) Then
