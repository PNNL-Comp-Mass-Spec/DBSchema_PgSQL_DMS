...
--
CREATE OR REPLACE FUNCTION public.job_backlog_on_date_by_tool
(
    _targetDate timestamp,
    _analysisJobToolID int = 1
)
RETURNS integer
LANGUAGE plpgsql
AS $$
...
COMMENT ON FUNCTION public.job_backlog_on_date_by_tool IS 'JobBacklogOnDateByTool';
