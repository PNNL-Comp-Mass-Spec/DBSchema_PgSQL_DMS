...
-- This procedure has been implemented (as a function)
--
CREATE OR REPLACE FUNCTION public.verify_sp_authorized
(
    _procedureName text,
    _targetSchema text DEFAULT 'public',
...
COMMENT ON FUNCTION public.verify_sp_authorized IS 'VerifySPAuthorized';
