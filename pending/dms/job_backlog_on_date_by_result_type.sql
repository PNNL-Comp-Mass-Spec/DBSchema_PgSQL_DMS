...
--
CREATE OR REPLACE FUNCTION public.job_backlog_on_date_by_result_type
(
    _targetdate timestamp,
    _resulttype citext DEFAULT 'MSG_Peptide_Hit'
)
RETURNS integer
LANGUAGE plpgsql
AS $$
...
COMMENT ON FUNCTION public.job_backlog_on_date_by_result_type IS 'JobBacklogOnDateByResultType';
