...
ALTER VIEW public.v_predefined_analysis_scheduling_queue_list_report OWNER TO d3l243;
...
GRANT SELECT ON TABLE public.v_predefined_analysis_scheduling_queue_list_report TO writeaccess;
