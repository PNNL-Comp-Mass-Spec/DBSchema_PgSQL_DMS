...
ALTER FOREIGN TABLE pnnldata."VW_PUB_SPACE" ALTER COLUMN "SPACE_ID" OPTIONS (
    column_name 'SPACE_ID'
);
ALTER FOREIGN TABLE pnnldata."VW_PUB_SPACE" ALTER COLUMN "FACILITY_ID" OPTIONS (
    column_name 'FACILITY_ID'
);
ALTER FOREIGN TABLE pnnldata."VW_PUB_SPACE" ALTER COLUMN "FLOOR_NO" OPTIONS (
    column_name 'FLOOR_NO'
);
ALTER FOREIGN TABLE pnnldata."VW_PUB_SPACE" ALTER COLUMN "ACTIVE_SW" OPTIONS (
    column_name 'ACTIVE_SW'
);
ALTER FOREIGN TABLE pnnldata."VW_PUB_SPACE" ALTER COLUMN "FIRE_ZONE" OPTIONS (
    column_name 'FIRE_ZONE'
);
ALTER FOREIGN TABLE pnnldata."VW_PUB_SPACE" ALTER COLUMN "IOPS_SPACE_SW" OPTIONS (
    column_name 'IOPS_SPACE_SW'
);
ALTER FOREIGN TABLE pnnldata."VW_PUB_SPACE" ALTER COLUMN "SPACE_NAME" OPTIONS (
    column_name 'SPACE_NAME'
);
ALTER FOREIGN TABLE pnnldata."VW_PUB_SPACE" ALTER COLUMN "SPACE_STATUS_CD" OPTIONS (
    column_name 'SPACE_STATUS_CD'
);
ALTER FOREIGN TABLE pnnldata."VW_PUB_SPACE" ALTER COLUMN "SQ_FEET" OPTIONS (
    column_name 'SQ_FEET'
);
ALTER FOREIGN TABLE pnnldata."VW_PUB_SPACE" ALTER COLUMN "TYPE_OF_SPACE_CD" OPTIONS (
    column_name 'TYPE_OF_SPACE_CD'
);
ALTER FOREIGN TABLE pnnldata."VW_PUB_SPACE" ALTER COLUMN "CATKEY" OPTIONS (
    column_name 'CATKEY'
);
ALTER FOREIGN TABLE pnnldata."VW_PUB_SPACE" ALTER COLUMN "CATEGORY_OF_SPACE_CD" OPTIONS (
    column_name 'CATEGORY_OF_SPACE_CD'
);
ALTER FOREIGN TABLE pnnldata."VW_PUB_SPACE" ALTER COLUMN "PHONE_NO" OPTIONS (
    column_name 'PHONE_NO'
);
ALTER FOREIGN TABLE pnnldata."VW_PUB_SPACE" ALTER COLUMN "LIFECYCLE_STATUS" OPTIONS (
