--
-- Name: move_task_down(bigint); Type: FUNCTION; Schema: timetable; Owner: d3l243
--

CREATE OR REPLACE FUNCTION timetable.move_task_down(task_id bigint) RETURNS boolean
    LANGUAGE sql
    AS $_$
...
ALTER FUNCTION timetable.move_task_down(task_id bigint) OWNER TO d3l243;

--
-- Name: FUNCTION move_task_down(task_id bigint); Type: COMMENT; Schema: timetable; Owner: d3l243
--
