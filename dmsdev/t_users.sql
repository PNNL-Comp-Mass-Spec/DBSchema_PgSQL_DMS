...
CREATE TABLE public.t_users (
    ...
    CONSTRAINT ck_t_users_name_whitespace CHECK ((public.has_whitespace_chars((name)::text, true) = false)),
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.t_users TO writeaccess;
