...
ALTER VIEW public.v_instrument_allowed_dataset_type_list_report OWNER TO d3l243;
...
GRANT SELECT ON TABLE public.v_instrument_allowed_dataset_type_list_report TO writeaccess;
