--
-- Name: v_lc_cart_settings_history_list_report; Type: VIEW; Schema: public; Owner: d3l243
--

CREATE VIEW public.v_lc_cart_settings_history_list_report AS
...
GRANT SELECT ON TABLE public.v_lc_cart_settings_history_list_report TO readaccess;
GRANT SELECT ON TABLE public.v_lc_cart_settings_history_list_report TO writeaccess;
