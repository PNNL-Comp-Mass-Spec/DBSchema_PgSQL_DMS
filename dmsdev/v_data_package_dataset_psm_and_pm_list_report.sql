--
-- Name: v_data_package_dataset_psm_and_pm_list_report; Type: VIEW; Schema: public; Owner: d3l243
--

CREATE VIEW public.v_data_package_dataset_psm_and_pm_list_report AS
 SELECT psm.data_pkg,
    psm.dataset,
...
GRANT SELECT ON TABLE public.v_data_package_dataset_psm_and_pm_list_report TO readaccess;
GRANT SELECT ON TABLE public.v_data_package_dataset_psm_and_pm_list_report TO writeaccess;
