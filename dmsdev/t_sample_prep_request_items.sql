...
ALTER TABLE ONLY public.t_sample_prep_request_items
    ADD CONSTRAINT fk_t_sample_prep_request_items_t_sample_prep_request FOREIGN KEY (prep_request_id) REFERENCES public.t_sample_prep_request(prep_request_id);
