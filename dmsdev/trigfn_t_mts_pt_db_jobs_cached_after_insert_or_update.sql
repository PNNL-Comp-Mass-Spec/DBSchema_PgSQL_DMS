--
-- Name: trigfn_t_mts_pt_db_jobs_cached_after_insert_or_update(); Type: FUNCTION; Schema: public; Owner: d3l243
--

CREATE OR REPLACE FUNCTION public.trigfn_t_mts_pt_db_jobs_cached_after_insert_or_update() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
/****************************************************
**
...
ALTER FUNCTION public.trigfn_t_mts_pt_db_jobs_cached_after_insert_or_update() OWNER TO d3l243;
